...

{
    ...
    {
        [DisplayName("Расход Системы")] public double SystemFlow { get; set; }

        [DisplayName("Наименование Системы")] public string system_name { get; set; }

        [DisplayName("Тип оборудования")] public string system_equipment_type { get; set; }

        [DisplayName("ID Оборудования")] public string equipment_id { get; set; }

        [DisplayName("Тип оборудования")] public string family_device_name { get; set; }

        [DisplayName("Экземпляр оборудования")]  public string family_instance_name { get; set; }

        [DisplayName("Макс. расход")] public double max_flow { get; set; }
        ...
        [DisplayName("Кэф ")] public double KEf { get; set; }
